 ...
 */
public class MyVisitCategoriesAdapter extends BaseAdapter implements StickyListHeadersAdapter {

    private LayoutInflater inflater;
    private Context context;
    private MyVisitsCategoriesActivity activity;
    private ArrayList<Categories> categoryList;

    public MyVisitCategoriesAdapter(Context context, ArrayList<Categories> categoryList) {
        this.context = context;
        this.inflater = LayoutInflater.from(context);
        this.activity = (MyVisitsCategoriesActivity)context;
    ...
    public View getHeaderView(int i, View view, ViewGroup viewGroup) {
        ...
        activity.setFont(activity.getTfSegoe(),holder.tvHeader);
        return view;
    }
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
                ...
                new FlipHorizontalAnimation(view)
                        ...
                        .setListener(new AnimationListener() {
                            ...
                            public void onAnimationEnd(Animation animation) {
                                ParseObject visitor = activity.getVisitor().get(0);
                                ...
                                Log.d("prod", "current " + activity.getMyProductFavorites().toString());
                                for (String s : activity.getMyProductFavorites()) {
                                    if (!s.equals(id)) {
                                        toUpdate.add(s);
                                    }
                                }
                                ...
                                activity.getMyProductBookMarks();
                                MyVisitCategoriesAdapter.this.notifyDataSetChanged();
                            }
                        }).animate();
            }
        });
        ...
        activity.setFont(activity.getTfBootstrap(),holder.tvFavorite);
        activity.setFont(activity.getTfSegoe(),holder.tvRow);
        activity.setFont(activity.getTfSegoe(),holder.tvBoothNo);
        return view;
    }
